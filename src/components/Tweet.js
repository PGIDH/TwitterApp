...
function Tweet(data) {
    ...
    //         fetch("http://demo9548547.mockable.io/tweets/1")
    //         .then(res => res.json())
    ...
    return (
        <div style={{ borderBottom: '1px rgb(47, 51, 54) solid' }}>
            <div className="tweet-section">
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                <div className="tweet-body">
                                    <div className="user-info">
                                        ...
                                        <span style={{ color: 'rgb(113, 118, 123)' }}>{tweetData.tweetTime}</span>
                                    </div>
                                    ...
                                    <div className="tweetNums">
                                        <div>
                                            <svg viewBox="0 0 24 24" className="tweetNums">
                                                <g fill="rgb(113, 118, 123)">
                ...
                <img src={data.data.image} style={{ width: '400px', height: '300px', paddingBottom:'12px' }}></img>
            </div> */}
                        </div>
                    </>
                )}
